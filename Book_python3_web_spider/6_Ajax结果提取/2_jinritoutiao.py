...
def get_page(offset):
    headers = {
        ...
        'cookie': 'tt_webid=6798825554043192845; s_v_web_id=verify_k77ietr6_kS4f7HMl_bVBw_4pSs_B5zL_H5XmX4E2UMxy; ttcid=f8116941129d436992db9e7b31ad863266; WEATHER_CITY=%E5%8C%97%E4%BA%AC; tt_webid=6798825554043192845; csrftoken=41fdfd20c0a0b7917eb79594a70aa7f6; SLARDAR_WEB_ID=vn; tt_scid=Rz4YmwamlMX.-RfZyDJ3KElKRkUNs6N87NCvkuVLL0S.ljWMcma.0IusAxAvaVoJc4d8; __tasessionId=z3ydprnz81582984958899',
...
if __name__ == '__main__':
    ...
    '''
    pool = Pool()
    groups = ([x * 20 for x in range(0, 1)])
